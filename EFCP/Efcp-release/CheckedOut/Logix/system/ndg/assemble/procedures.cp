...
instructions(Instructions, Requests, EndRequests, Items, EndItems,
	...
	auy#call_args(Name, OpCode, Args, else(Address), N,
    ...
    Name =\= "=:=" , Name =\= "=" :	% Transitional kluge
      Guards ! guard_index(Name/N, OpCode) |
	auy#call_args(Name,OpCode, Args, (fail(Address1), suspend(Address2)), N,
	...
	auy # unify_args(Asgns,Args,Requests', Requests'',
			Items', Items'', N, 0),
	instructions;

    Instructions ? deref(Arg1, Arg2, Arg3) |
	instructions,
	auy # deref(Arg1, Arg2, Arg3, Requests, Requests', Items, Items',
		Instructions', Instructions'');

    Instructions ? deref_car(Arg1, Arg2, Arg3) |
	instructions,
	auy # registers([Arg1, Arg2, Arg3], 1, Requests, Requests',
			Items, [FCP_dg_deref_car_3 | Items'], deref_car, '');

    Instructions ? deref_value(a(I), a(K)) |
	instructions,
	auy # deref_value(I, K, Requests, Requests', Items, Items',
			  Instructions', Instructions'');
	...
	instructions;
     ...
     Instructions ? deref_vars(Regs, Label), Regs =\= [a(_)] :
      ...
      Items = [FCP_dg_deref_vars, K | OtherItems] |
       instructions,
       auy#do_vars(Regs, Arguments, K, 0, [Reference | Items'], 
			OtherItems, Count, 2);
    ...
    integer(I), integer(K) :
      ...
      Items = [FCP_dg_switch_on_tag, RegE(I), RegE(K), N, TagBitsWord
	      | Items'] |
	auy#tag_labels(TagLabels, N, TagBits, Requests', Requests'',
    ...
    N := High - Low :
      ...
      Items = [FCP_dg_drf2_branch_integer, RegE(I), RegE(K), LowI, HighI
	      | Items'] |
	auy#branch_labels(Labels, Requests', Requests'', Items', Items'',
	...
	auy#case_hash(EntryList, NArguments, Requests', Requests'',
			Items', Items''
	),
	instructions;
	...
	instructions,
	auy#registers([Arg], 1, Requests, Requests', Items,
    ...
    Instructions ? allocate_vars(Regs) :
      ...
      Items = [FCP_dg_allocate_vars, K | OtherItems] |
       instructions,
       auy#do_vars(Regs, Arguments, K, 0, Items', OtherItems, Count, 2);

    Instructions ? allocate_tuple(Args, Arg) |
	instructions,
	auy#registers([Arg], 2, Requests, Requests',
	...
	instructions,
	auy#allocate_list(Args, Arg, Requests, Requests', Items, Items',
			Instructions', Instructions''
	);

    Instructions ? allocate_pr(Args, Arg) |
	instructions,
	auy#allocate_enqueue(Args, Arg, Instructions', Instructions'', Summary),
	auy#allocate_pr(Summary, Requests, Requests', Items, Items');

     Instructions ? fetch(Term, Register) |
	instructions,
	auy#fetch(Term, Register, Requests, Requests', Items, Items');
...
instructions2(Instructions, Requests, EndRequests, Items, EndItems,
    ...
    Instructions ? if_tag(a(I), "=\=", Tag, Label) |
	auy#if_tag_not(I, Tag, Label, Requests, Requests', Items, Items',
		Instructions', Instructions''
	),
	instructions(Instructions'', Requests', EndRequests, Items', EndItems,
			Guards, EndGuards
	...
	auy#special_arg(Comparee, integer(Comparee), Comparee'),
	auy#special_arg(Comparand, integer(Comparand), Comparand'),
	auy#ifs(IfIntegerBaseOp, integer, Comparee', Relation, Comparand', Label,
	...
	auy#ifs(IfRealBaseOp, real, Comparee, Relation, Comparand, Label,
		Requests, Requests', Items, Items'
	),
	instructions(Instructions', Requests', EndRequests, Items', EndItems,
			Guards, EndGuards
	...
	auy#ifs(IfStringBaseOp, string, Comparee, Relation, Comparand, Label,
		Requests, Requests', Items, Items'
	),
	instructions(Instructions', Requests', EndRequests, Items', EndItems,
			Guards, EndGuards
	...
	auy#special_arg(Comparee, tuple(Comparee), Comparee'),
	auy#special_arg(Comparand, tuple(Comparand), Comparand'),
	auy#ifs(IfTupleBaseOp, tuple, Comparee', Relation, Comparand', Label,
		   Requests, Requests', Items, Items'
	),
	instructions(Instructions', Requests', EndRequests, Items', EndItems,
			Guards, EndGuards
	...
	auy#registers([Arg], 1, Requests, Requests',
		  Items, [FCP_dg_case_hash_integer | Items'],
		  case_hash_integer, Arguments
	),
	auy#case_hash(EntryList, Arguments, Requests', Requests'',
			Items', Items''
	),
	instructions(Instructions', Requests'', EndRequests, Items'', EndItems,
			Guards, EndGuards
	...
	auy#special_arg(Comparee, integer(Comparee), Comparee'),
	auy#special_arg(Comparand, integer(Comparand), Comparand'),
	auy#compare(CompareIntegerBaseOp, int_, Comparee', Relation, Comparand', 
	...
	auy#do_integer_arith(plus_, Plus_BaseOp, IntArg1, IntArg2, RegArg, 
				Requests, Requests', Items, Items'),
	instructions(Instructions', Requests', EndRequests, Items', EndItems,
			Guards, EndGuards
	);
	...
	auy#do_integer_arith(cmt_plus_, CmtPlus_BaseOp, IntArg1, IntArg2,
	...
	auy#do_number_arith(plusnum_, Plus_number_BaseOp, NumArg1, NumArg2,
	...
	auy#do_number_arith(cmt_plusnum_, CmtPlus_number_BaseOp,
			    NumArg1, NumArg2, Reg,
			    Requests, Requests', Items, Items'),
	instructions(Instructions', Requests', EndRequests, Items', EndItems,
			Guards, EndGuards
	...
	auy#do_integer_arith(diff_, Diff_BaseOp, IntArg1, IntArg2, RegArg, 
				Requests, Requests', Items, Items'),
	instructions(Instructions', Requests', EndRequests, Items', EndItems,
			Guards, EndGuards
	);
	...
	auy#do_integer_arith(cmt_diff_, CmtDiff_BaseOp,IntArg1, IntArg2,
			     RegArg, Requests, Requests', Items, Items'),
	instructions(Instructions', Requests', EndRequests, Items', EndItems,
			Guards, EndGuards
	);
	...
	auy#do_number_arith(diffnum_, Diff_number_BaseOp, NumArg1, NumArg2,
			    Reg, Requests, Requests', Items, Items'),
	instructions(Instructions', Requests', EndRequests, Items', EndItems,
			Guards, EndGuards
	);
	...
	auy#do_number_arith(cmt_diffnum_, CmtDiff_number_BaseOp,
