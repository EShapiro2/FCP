...
expand(Command, Cs) :-
  ...
  defer_command(Command, V, Cs) :-
    true :
      Cs = [to_context(computation # shell(defer, V, system(Command)))
	   | Commands]\Commands.
...
*/
    ...
    Command = "_complete_names"(Head, Tail) :
      Tail = [forward,  hi, macros, system | Tail'],
...
/**/
    Command = debug_system_macros(Macro) :
      Cs = [Macro |  Commands]\Commands;
/**/
    otherwise :
