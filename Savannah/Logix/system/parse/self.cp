...
**
     ...
     Copyright 2007 Michael Hirsch, Marc Rosen, Muli Safra, William Silverman
...
after_term(Result1, Delimiter, Priority1, Term1, Priority2, Tokens,
    ...
    Os1 = [] :
      Os2 = [] |
	lookup(infix_operator(String, PLeft, Pop, PRight, Reply)),
...
look_ahead1(String, Kind, NextType, Os1,Os2) :-
	...
	look_ahead2(Prefix, String, NextType);
...
% add the infix operator "<==>" you must change 4 to 5 in lookup/1-2, below.
