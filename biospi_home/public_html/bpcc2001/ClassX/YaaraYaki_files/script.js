...
var gDocTable = new Array(
   ...
   new hrefList("slide0047.htm", 1, 18),
   new hrefList("slide0048.htm", 1, 19),
   new hrefList("slide0018.htm", 1, 20),
   new hrefList("slide0019.htm", 1, 21),
   new hrefList("slide0020.htm", 1, 22),
   ...
   new hrefList("slide0039.htm", 1, 37),
   new hrefList("slide0040.htm", 1, 38),
   new hrefList("slide0041.htm", 1, 39),
   new hrefList("slide0042.htm", 1, 40),
   new hrefList("slide0043.htm", 1, 41),
   new hrefList("slide0049.htm", 1, 42),
   new hrefList("slide0050.htm", 1, 43),
   new hrefList("slide0051.htm", 1, 44),
   new hrefList("slide0045.htm", 1, 45),
   new hrefList("slide0053.htm", 1, 46),
   new hrefList("slide0054.htm", 1, 47),
   new hrefList("slide0055.htm", 1, 48),
   new hrefList("slide0056.htm", 1, 49),
   new hrefList("slide0005.htm", 1, 50)
);
