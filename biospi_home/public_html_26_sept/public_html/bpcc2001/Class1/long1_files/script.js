...
var ENDSHOW_MESG="End of slide show, click to exit.", SCREEN_MODE="Frames", gIsEndShow=0, NUM_VIS_SLDS=89, SCRIPT_HREF="script.js", FULLSCR_HREF="fullscreen.htm";
...
var gDocTable = new Array(
   ...
   new hrefList("slide0199.htm", 1, 6),
   new hrefList("slide0200.htm", 1, 7),
   ...
   new hrefList("slide0201.htm", 1, 18),
   ...
   new hrefList("slide0037.htm", 1, 35),
   ...
   new hrefList("slide0118.htm", 1, 46),
   new hrefList("slide0119.htm", 1, 47),
   new hrefList("slide0120.htm", 1, 48),
   new hrefList("slide0121.htm", 1, 49),
   new hrefList("slide0122.htm", 1, 50),
   new hrefList("slide0123.htm", 1, 51),
   new hrefList("slide0124.htm", 1, 52),
   new hrefList("slide0125.htm", 1, 53),
   new hrefList("slide0126.htm", 1, 54),
   new hrefList("slide0127.htm", 1, 55),
   new hrefList("slide0128.htm", 1, 56),
   new hrefList("slide0129.htm", 1, 57),
   new hrefList("slide0130.htm", 1, 58),
   new hrefList("slide0131.htm", 1, 59),
   new hrefList("slide0132.htm", 1, 60),
   new hrefList("slide0133.htm", 1, 61),
   new hrefList("slide0134.htm", 1, 62),
   new hrefList("slide0135.htm", 1, 63),
   new hrefList("slide0136.htm", 1, 64),
   new hrefList("slide0196.htm", 1, 65),
   new hrefList("slide0195.htm", 1, 66),
   new hrefList("slide0137.htm", 1, 67),
   new hrefList("slide0198.htm", 1, 68),
   new hrefList("slide0194.htm", 1, 69),
   new hrefList("slide0138.htm", 1, 70),
   new hrefList("slide0139.htm", 1, 71),
   new hrefList("slide0177.htm", 1, 72),
   new hrefList("slide0140.htm", 1, 73),
   new hrefList("slide0181.htm", 1, 74),
   new hrefList("slide0182.htm", 1, 75),
   new hrefList("slide0183.htm", 1, 76),
   new hrefList("slide0184.htm", 1, 77),
   new hrefList("slide0186.htm", 1, 78),
   new hrefList("slide0143.htm", 1, 79),
   new hrefList("slide0144.htm", 1, 80),
   new hrefList("slide0191.htm", 1, 81),
   new hrefList("slide0187.htm", 1, 82),
   new hrefList("slide0188.htm", 1, 83),
   new hrefList("slide0192.htm", 1, 84),
   new hrefList("slide0193.htm", 1, 85),
   new hrefList("slide0145.htm", 1, 86),
   new hrefList("slide0190.htm", 1, 87),
   new hrefList("slide0189.htm", 1, 88),
   new hrefList("slide0202.htm", 1, 89)
);
